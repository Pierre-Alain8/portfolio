const projects = [
  {
    id: "project-" + 1,
    title: "MyStore Angular - Application web ",
    subtitle: "Développement d'une application frontend sous angular",
    cover: "img/angular-project.jpg",
    resume:
      "Afin de me lancer dans l'aprentissage de framework javascript, j'ai choisit de développer une application simple de e-commerce",
    img: "img/my-store-angular.PNG",
    technologies: "Angular",
    language: "Javascript",
    category: "web",
    link: "https://stackblitz.com/edit/angular-pa-my-first-app",
  ...
  //   cover: "img/kimia.jpg",
  //   resume:
  //     "Kimia café est un café cantine éco-responsable accessible à tous créé par Fabienne Briet, au cours de ma formation de développeur web et mobile, dans le cadre d'un stage à l'aide de deux autres apprenants, travaillant en mode projet nous avions collaboré avec Fabienne pour la conception du site internet Kimia.",
...

  {
    ...
    resume:
      "Guillaume Singelin est un jeune auteur/déssinateur de bande dessinée",
    img: "img/PTSD.jpg",
    technologies: "wordpress",
    langage: null,
    category: "interviews",
